...
public class FruitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CollapsingToolbarLayout collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collaps_toolbar);
        ...
        String fruitContent = generateFruitContet(fruitName);
        fruitContextText.setText(fruitContent);
    }

    private String generateFruitContet(String fruitName) {
